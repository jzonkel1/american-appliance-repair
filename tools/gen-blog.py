...
SHOTS = [
 ...
 ("gal-range-service-kitchen.jpg","Servicing a gas range on site — burners, igniters and controls checked before we call the job done."),
 ("gal-fridge-kitchen-service.jpg","Refrigerator service in a customer's kitchen. Fridge calls get treated as urgent — every hour costs you food."),
 ("gal-fridge-multimeter.jpg","Meter on the terminals behind a refrigerator: diagnosis first, so you're quoted a repair that actually fixes it."),
 ("gal-behind-fridge.jpg","Pulled out and opened up — the real work usually happens behind the appliance, not in front of it."),
 ("gal-laundry-closet-team.jpg","Two technicians working a stacked laundry closet — tight spaces are part of the job in Coastal Bend homes."),
 ("gal-laundry-closet-service.jpg","Washer and dryer service in a laundry closet, with everything put back the way we found it."),
 ("gal-flashlight-repair.jpg","Light in one hand, tools in the other. Careful diagnosis beats guessing at parts."),
 ("gal-evaporator-coils.jpg","Evaporator coils exposed on a refrigerator — this is where most cooling problems are found and fixed."),
 ("gal-dishwasher-interior.jpg","Inside a dishwasher: pumps, seals and spray arms serviced so dishes come out clean again."),
 ("gal-dryer-blower.jpg","A dryer opened down to the blower housing — the failed part comes out, a new one goes in."),
 ("gal-internal-wiring.jpg","Behind the panel: wiring, valves and controls checked as part of a full diagnosis."),
 ("gal-terminal-wiring.jpg","Terminal connections and heavy-gauge wiring inspected — commercial equipment gets the same careful work."),
 # ---- why dryer maintenance matters ----
 ("gal-vent-lint-buildup.jpg","This is what a neglected dryer vent looks like inside. Lint packs the duct where you can't see it, airflow chokes, and heat has nowhere to go."),
 ("gal-duct-lint-attic.jpg","Ductwork opened up above the ceiling — years of lint buildup, and a real fire risk. Cleaning the filter isn't enough."),
 ("gal-vent-duct-wall.jpg","Vent runs hidden inside walls and floors get inspected too. This is the part of dryer safety most homeowners never see."),
 # ---- the parts store ----
 ...
 ("gal-parts-boxes.jpg","Shelf after shelf of boxed parts — the inventory behind our one-visit repairs."),
 ("gal-warehouse-shelving.jpg","The parts warehouse keeps growing — new shelving going up to hold even more inventory."),
 ("gal-shelving-going-up.jpg","Fresh racking installed and waiting to be filled. The parts department keeps expanding."),
 ...
 ("gal-marcone-meeting.jpg","Sitting down with Marcone — the partnership that keeps more parts on our shelves and more repairs finished same-visit."),
 ...
 ("gal-showroom-ranges.jpg","Ranges lined up on the floor — gas and electric, new and scratch-&-dent, priced to move."),
 ("gal-showroom-laundry.jpg","Washers and dryers ready to go home today. Delivery, installation and haul-away are available."),
 ("gal-laundry-center.jpg","A stacked laundry center on the floor — the answer when the laundry space is tight."),
 ("gal-showroom-wall-oven.jpg","Wall oven and microwave combination units — the kind of piece that's hard to find locally."),
 ("gal-showroom-oven.jpg","Built-in wall ovens on the showroom floor at 3701 Apollo Rd."),
 ("gal-oven-interior.jpg","Inside and out: every unit we sell gets looked over before it goes on the floor."),
 ("gal-clearance-fridge.jpg","A clearance-tagged refrigerator — full function, better price. Scratch-&-dent is the smartest money in appliances."),
 ("gal-warehouse-dishwashers.jpg","Dishwashers racked and waiting in the warehouse — inventory rotates through the floor weekly."),
 ("gal-double-oven-pallet.jpg","A double wall oven coming off the pallet jack and onto the floor."),
 ...
 ("gal-delivery-truck-loaded.jpg","The box truck loaded and strapped for delivery day across Corpus Christi and the Coastal Bend."),
 # ---- the people ----
