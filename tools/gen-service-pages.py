...
FOOTER = '''<footer>
  <div class="wrap">
    ...
    <div>
      ...
      <div class="soc"><a href="https://www.facebook.com/p/American-Appliance-Repair-61554373376502/" target="_blank" rel="noopener" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 21v-8h2.7l.4-3.1h-3.1V7.9c0-.9.25-1.5 1.55-1.5H16.7V3.6c-.3-.04-1.3-.13-2.5-.13-2.5 0-4.2 1.5-4.2 4.3v2.1H7.3V13h2.7v8z"/></svg></a><a href="https://www.instagram.com/american__appliance_repair/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4.2"/><circle cx="17.4" cy="6.6" r="1.3" fill="currentColor" stroke="none"/></svg></a></div>
    </div>
  </div>
  <div class="wrap fbot">
...
<section style="background:var(--cool);border-top:1px solid var(--line-cool);">
  <div class="wrap">
    <div class="sec-head rv">
      ...
      <h2 class="sec">4.8 stars across 176 Google reviews</h2>
    </div>
